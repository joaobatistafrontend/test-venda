...
urlpatterns = [
    ...
    path('add_prod_carrinho/<int:produto_id>/', adicionar_no_carrinho, name='add_da_venda'),
    path('remover_prod_carrinho/<int:produto_id>/', remover_do_carrinho, name='remover_da_venda'),
]
